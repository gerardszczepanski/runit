...
import szczepanski.gerard.runit.search.result.impl.WebPageResult;
...
public class LexicalFrequencySearchCacheCacheContainerTest {
    ...
    public void testInitializeWithEmptyBucket() {
        ...
        // Act
        LexicalFrequencySearchCache.CacheContainer container = new LexicalFrequencySearchCache.CacheContainer(size, 2);
    ...
    public void addNewSearchResultToBucket() {
        ...
        LexicalFrequencySearchCache.CacheContainer container = new LexicalFrequencySearchCache.CacheContainer(size, 3);
    ...
    public void freeContainerMemoryIfNeeded() {
        ...
        LexicalFrequencySearchCache.CacheContainer container = new LexicalFrequencySearchCache.CacheContainer(size, bucketsToRelease); //nextPointer = 1
    ...
    public void splitBucketsSuccess() {
        ...
        LexicalFrequencySearchCache.CacheContainer container = new LexicalFrequencySearchCache.CacheContainer(size, bucketsToRelease);
        container.addNewSearchResultsToBucket(searchTerm, searchResults);
