...
public class SettingsPropertiesMapper {
	...
	public Settings toSettings(Properties properties) {
		return Settings.builder()
				.rootDirectioresToScan(
						stringPropertySpliterator.fromPropertyString(properties.getProperty(ROOT_DIRECTORIES_KEY)))
				.fileExtensions(
						stringPropertySpliterator.fromPropertyString(properties.getProperty(FILE_EXTENSIONS_KEY)))
				.webAliases(aliasPropertySpliterator.fromPropertyString(properties.getProperty(WEB_ALIASES_KEY)))
				.dirAliases(
						aliasPropertySpliterator.fromPropertyString(properties.getProperty(DIRECTORIES_ALIASES_KEY)))
				.build();
	}
